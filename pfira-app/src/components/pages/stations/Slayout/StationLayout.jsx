...
import { FiMenu, FiX, FiBell, FiUser, FiSettings, FiLogOut, FiUsers } from 'react-icons/fi';
              ...
              <div className="relative">
                ...
                {profileOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-20">
                    ...
                    <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-red-600 hover:text-amber-50 flex items-center">
